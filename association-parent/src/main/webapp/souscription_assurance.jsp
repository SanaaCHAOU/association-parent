...
<html>
    ...
    <body style="width: 50%; margin: 0 auto;">
        ...
        <form action="/association-parent/controlleur/souscription" method="POST">
            <div id="form-inscr">
                <table>
                    <tbody>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="nom_parent_1" value="" /></td>
                        </tr>
                        <tr>
                            <td>Prénom tuteur <span style="color: red">*</span>:</td>
                            <td><input type="text" name="prenom_parent_1" value="" /></td>
                        </tr>
                        <tr>
                            <td>Email <span style="color: red">*</span>:</td>
                            <td><input type="text" name="email_parent_1" value="" /></td>
                        </tr>   
                        <tr>
                            <td>Téléphone <span style="color: red">*</span>:</td>
                            <td><input type="text" name="telephone_parent_1" value="" /></td>
                        </tr>  
                        <tr>
